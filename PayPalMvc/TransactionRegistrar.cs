...
namespace PayPalMvc
{
	...
	public class TransactionRegistrar : ITransactionRegistrar
    {
        ...
        {
            SetExpressCheckoutRequest request = new SetExpressCheckoutRequest(uniqueCode, allowNote, noShipping, currencyCode, amount, itemTotalAmount, taxAmount, description, trackingReference, serverURL, purchaseItems, userEmail);
